		...
		if (ajax.readyState == 4) {
			...
			html+=`<table>
					<tr>
						...
						<th><a href="javascript:ordenar('fecha_nacimiento')">Fecha Nacimiento</a></th>
						<th><a href="javascript:ordenar('direccion')">Direccion</a></th>
						<th><a href="javascript:ordenar('numero_mesa')">Numero Mesa</a></th>
					</tr>`
			for(i=0;i<lista.length;i++){
				html+=`<tr>
						...
						<td>${lista[i].numero_mesa}</td>
						<td>
							<a href="javascript:cargarContenido('update.php?id=${lista[i].id}')">Editar</a>
							<a href="javascript:confirmar('Desea eliminar a la persona',${lista[i].id})">Eliminar</a>
						</td>
					</tr>`
			}
